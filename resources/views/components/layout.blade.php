                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <x-nav-link typeNav="a" href="/"  :active="request()->is('/')">Home</x-nav-link>
                            <x-nav-link typeNav="button" href="/about" :active="request()->is('about')">About</x-nav-link>
                            <x-nav-link typeNav="button" href="/contact" :active="request()->is('contact')">Contact</x-nav-link>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
